...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        $usuario = isset($_POST['usuario']) ? limpiarEntrada($_POST['usuario']) : '';
        ...
        // Conexión a la base de datos usando la función centralizada
        $pdo = getDBConnection();
        ...
        if ($user_data && password_verify($contrasena, $user_data['contrasena'])) {
            ...
            // VARIABLES CONSISTENTES CON modulos.php y session_manager.php
