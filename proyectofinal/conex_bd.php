...
// conex_bd.php - Configuracion de base de datos y funciones comunes

// Configuracion de la base de datos
define('DB_HOST', 'localhost');
define('DB_NAME', 'proyecto-final');
define('DB_USER', 'root');
define('DB_PASS', ''); // Cambiar por tu contrasena de MySQL
define('DB_CHARSET', 'utf8mb4');

/**
 * CLASE DATABASE - AGREGADA PARA CORREGIR EL ERROR
 * Esta clase se necesita en administrador.php
 */
class Database {
     ...
     * @return PDO Conexion PDO a la base de datos
     */
 ...
 * @return PDO Conexion PDO a la base de datos con prepared statements
 * @throws Exception Si hay error en la conexion
 */
 ...
 * @param int $statusCode Codigo de estado HTTP (por defecto 200)
 */
...
/**
 * Funcion para sanitizar entrada de datos
 ...
 * @param PDOException $e Excepcion de PDO
 * @param string $operation Operacion que se estaba realizando
...
function handleDBError(PDOException $e, $operation = '') {
    ...
    // En desarrollo, mostrar mas detalles (cambiar a false en produccion)
    $debug_mode = true;
...
/**
 * Funcion para verificar la conexion de base de datos
 * @return bool True si la conexion es exitosa
 */
...
/**
 * Funcion para log de actividades
...
/**
 * Funcion adicional para validar codificacion UTF-8
 * @param string $string Cadena a validar
 * @return bool True si es UTF-8 valido
 */
...
/**
 * Funcion para limpiar y validar entrada UTF-8
 * @param string $input Entrada a limpiar
 * @return string Entrada limpia y valida
 */
